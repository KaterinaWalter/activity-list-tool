...
export const BRAINSTORM_PROMPTS = [
  ...
  { q: 'Active in a religious community — choir, youth group, services?', tag: 'Faith' },
  ...
  { q: 'Started anything — a club, business, mutual aid, newsletter?', tag: 'Founder' },
  ...
  { q: 'Compete in non-sports — debate, chess, hackathons, esports, math?', tag: 'Competition' },
